...
//          Scene scene2 = new Scene();
            ...
            Button but1 = new Button("2048 Game");
            but1.setFont(font);
    //       game.setText(text.getText());
            //game1.setPadding(new Insets(10, 50, 100, 50));
            but1.setStyle("-fx-border-color:black; -fx-background-color: Orange");
            but1.setOnAction(e -> {
                    System.out.println("Launching 2048!");
                    Scene scene3 = game.getGameScene();
                    stage.setScene(scene3);
                });
            System.out.println("Fonts: " + javafx.scene.text.Font.getFamilies());
            Button but2 = new Button("Tetris Game");
            but2.setFont(font1);
            but2.setStyle("-fx-border-color:red; -fx-background-color: blue;");
//            game2.setPadding(new Insets(10, 50, 100, 50));
            but2.setOnAction(e -> {
                    System.out.println("Launching Tetris!");
                Scene scene2 = game1.getGameScene();
            ...
            VBox newPane = new VBox(but1, style, but2, exit);
